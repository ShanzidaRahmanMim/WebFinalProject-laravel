                    ...
                    <div class="card-body">
                      <form action="" method="POST">
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <input type="text" class="form-control" id="subcategory-name" name="subcategory_name" placeholder="Enter category name" />
                          </div>
                        </div>
                        <div class="row mb-3">
                          <label class="col-sm-2 col-form-label" for="basic-default-name">Product Price</label>
                          <div class="col-sm-10">
                            <input type="number" class="form-control" id="subcategory-name" name="subcategory_name" placeholder="Enter category name" />
                          </div>
                        </div>
                        <div class="row mb-3">
