...
<div class="row">
    ...
    <form action="{{route('placeorder')}}" method="POST">
        @csrf 
        <input type="submit" value="Place Order" class="btn btn-success mr-3" >
    </form>
    <form action="{{route('payonline',$total)}}" method="GET">
        @csrf 
        <input type="submit" value="Pay online" class="btn btn-warning">
    </form>
</div>
@endsection